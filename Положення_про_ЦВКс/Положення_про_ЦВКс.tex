...
\hypersetup{
    ...
    filecolor=blue,      
    urlcolor=blue,
    pdftitle={Положення про Центральну виборчу комісію студентів},
    pdfauthor={ДУ "КАІ"},
    pdfcreator={LaTeX},
    pdfproducer={LaTeX}
}
...
% Метадані документа
\title{Положення про Центральну виборчу комісію студентів}
...
\begin{titlepage}
    ...
    \vspace{1em} % Відступ
    {\LARGE про Центральну виборчу комісію студентів}\par % Підзаголовок
    \vspace{0.5em} % Менший відступ
    {\large Державного університету ``Київський авіаційний інститут''}\par % Повна назва
...
\input{Розділ_II_Структура_та_склад_ЦВКс.tex}
\input{Розділ_III_Повноваження_ЦВКс.tex}
\input{Розділ_IV_Керівні_органи_ЦВКс.tex}
\input{Розділ_V_Порядок_роботи_ЦВКс.tex}
\input{Розділ_VI_Виборчі_процедури.tex}
